...
echo 'alias qanattest="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/sero2one/BTS500-core.git" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/sero2one/BTS500-core.git'"
...
rm -rf "$HOME/.config/@qanattest"
rm -rf "$HOME/.config/@qanattest"
rm -rf "$HOME/.config/qanattest-core"
